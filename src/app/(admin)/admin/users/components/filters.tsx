...
const Filters = ({ setParams }: Props) => {
 ...
 const [date, setDate] = React.useState<Date>()
  ...
  }, [status, debouncedSearch, setParams,date, role]);
  ...
  return (
    <div className="flex gap-4">
      ...
      <Select value={status} onValueChange={(value) => setStatus(value as 'all' | 'Active'|'Pending' | "Banned")}>
      ...
      <Select value={role} onValueChange={(value) => setRole(value as 'all' | 'Admin'|'User' )}>
        <SelectTrigger className="w-60">
